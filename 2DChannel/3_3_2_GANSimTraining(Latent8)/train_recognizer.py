...
def train_progressive_gan(
  ...
  #  grid_realimgs = grid_in_dict['real']
   ...
   #     grid_labels_img = np.expand_dims(np.expand_dims(np.expand_dims(grid_labels, axis=-1),axis=-1),axis=-1)
    #    grid_labels_img = np.tile(grid_labels_img, (1,1,G.input_shapes[0][-3],G.input_shapes[0][-2],G.input_shapes[0][-1]))
  #  else:
